...
import { NavBar,Toast,Row, Col , Divider , Field , Uploader , Button , Notify,Popup,Icon
  ...
  ,Checkbox, CheckboxGroup,ImagePreview,Dialog,Loading,Overlay,Picker,Cell, CellGroup,Grid, GridItem,DatetimePicker
...
Vue.use(Row).use(Col).use(NavBar).use(Toast).use(Divider).use(Field).use(Uploader)
    ...
    .use(Cell).use(CellGroup).use(Grid).use(GridItem).use(DatetimePicker).use(Swipe).use(SwipeItem);
