...
//获取uccid
Bridge["getUccid"] = function(data = {}, callBack) {
  commonCallHandler("getUccid", data, callBack);
};
//打电话
Bridge["callCustomerService"] = function(data = {}, callBack) {
  commonCallHandler("callCustomerService", data, callBack);
};
//分享
Bridge["shareDialog"] = function(data = {}, callBack) {
  commonCallHandler("shareDialog", data, callBack);
};
//游戏分享
Bridge["gameShare"] = function(data = {}, callBack) {
  commonCallHandler("gameShare", data, callBack);
};
//打开相机
...
//打开相册
Bridge["getGallery"] = function(data = {}, callBack) {
  commonCallHandler("getGallery", data, callBack);
};
//跳转反馈
...
//跳转银行
Bridge["getBank"] = function(data = {}, callBack) {
  commonCallHandler("getBank", data, callBack);
};
//获取通讯录
...
//贷款产品详情
Bridge["appDetails"] = function(data = {}, callBack) {
  commonCallHandler("appDetails", data, callBack);
};
//点击下载
Bridge["appDetailsLink"] = function(data = "", callBack) {
  commonCallHandler("appDetailsLink", data, callBack);
};
//贷款产品详情页面分享
Bridge["shareLink"] = function(data = "", callBack) {
  commonCallHandler("shareLink", data, callBack);
};
